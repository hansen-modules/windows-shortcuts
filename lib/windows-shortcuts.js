...
function promiseHelper(callback, func) {
	if (!callback) {
...
exports.query = function(path, _callback) {
	return promiseHelper(_callback, callback => {
...
exports.create = function(path, optionsOrCallbackOrTarget, _callback) {
	var options = isString(optionsOrCallbackOrTarget) ? {target : optionsOrCallbackOrTarget} : optionsOrCallbackOrTarget;
	_callback = typeof optionsOrCallbackOrTarget === 'function' ? optionsOrCallbackOrTarget : _callback;
...
exports.edit = function(path, options, _callback) {
	return promiseHelper(_callback, callback => {
		execFile(__dirname + '/shortcut/Shortcut.exe',
